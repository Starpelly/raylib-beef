...
namespace Raylib_Beef
{
    public static class Raylib
    {
        ...
        public static extern bool IsWindowState(c_uint flag);
        ...
        public static extern void SetShaderValue(Shader shader, int locIndex, const void * value, int uniformType);
        
        [CallingConvention(.Cdecl), LinkName("SetShaderValueV")]
        /// Set shader uniform value vector
        public static extern void SetShaderValueV(Shader shader, int locIndex, const void * value, int uniformType, int count);
        ...
        public static extern void SetConfigFlags(c_uint flags);
        
        [CallingConvention(.Cdecl), LinkName("TraceLog")]
        /// Show trace log messages (LOG_DEBUG, LOG_INFO, LOG_WARNING, LOG_ERROR...)
        public static extern void TraceLog(int logLevel, char8* text, ... args);
        ...
        public static extern void * MemAlloc(c_uint size);
        
        [CallingConvention(.Cdecl), LinkName("MemRealloc")]
        /// Internal memory reallocator
        public static extern void * MemRealloc(void * ptr, c_uint size);
        ...
        public static extern unsigned char * LoadFileData(char8* fileName, unsigned int * bytesRead);
        
        [CallingConvention(.Cdecl), LinkName("UnloadFileData")]
        /// Unload file data allocated by LoadFileData()
        public static extern void UnloadFileData(unsigned char * data);
        
        [CallingConvention(.Cdecl), LinkName("SaveFileData")]
        /// Save data to file from byte array (write), returns true on success
        public static extern bool SaveFileData(char8* fileName, void * data, c_uint bytesToWrite);
        
        [CallingConvention(.Cdecl), LinkName("ExportDataAsCode")]
        /// Export data to code (.h), returns true on success
        public static extern bool ExportDataAsCode(const unsigned char * data, c_uint size, char8* fileName);
        ...
        public static extern long GetFileModTime(char8* fileName);
        
        [CallingConvention(.Cdecl), LinkName("CompressData")]
        /// Compress data (DEFLATE algorithm), memory must be MemFree()
        public static extern unsigned char * CompressData(const unsigned char * data, int dataSize, int * compDataSize);
        
        [CallingConvention(.Cdecl), LinkName("DecompressData")]
        /// Decompress data (DEFLATE algorithm), memory must be MemFree()
        public static extern unsigned char * DecompressData(const unsigned char * compData, int compDataSize, int * dataSize);
        
        [CallingConvention(.Cdecl), LinkName("EncodeDataBase64")]
        /// Encode data to Base64 string, memory must be MemFree()
        public static extern char8* EncodeDataBase64(const unsigned char * data, int dataSize, int * outputSize);
        
        [CallingConvention(.Cdecl), LinkName("DecodeDataBase64")]
        /// Decode Base64 string data, memory must be MemFree()
        public static extern unsigned char * DecodeDataBase64(const unsigned char * data, int * outputSize);
        ...
        public static extern void SetGesturesEnabled(c_uint flags);
        ...
        public static extern Image LoadImageFromMemory(char8* fileType, const unsigned char * fileData, int dataSize);
        ...
        public static extern void UpdateTexture(Texture2D texture, const void * pixels);
        
        [CallingConvention(.Cdecl), LinkName("UpdateTextureRec")]
        /// Update GPU texture rectangle with new data
        public static extern void UpdateTextureRec(Texture2D texture, Rectangle rec, const void * pixels);
        ...
        public static extern Color GetColor(c_uint hexValue);
        ...
        public static extern Font LoadFontFromMemory(char8* fileType, const unsigned char * fileData, int dataSize, int fontSize, int * fontChars, int glyphCount);
        ...
        public static extern GlyphInfo * LoadFontData(const unsigned char * fileData, int dataSize, int fontSize, int * fontChars, int glyphCount, int type);
        
        [CallingConvention(.Cdecl), LinkName("GenImageFontAtlas")]
        /// Generate image font atlas using chars info
        public static extern Image GenImageFontAtlas(const GlyphInfo * chars, Rectangle ** recs, int glyphCount, int fontSize, int padding, int packMethod);
        ...
        public static extern void DrawTextCodepoints(Font font, const int * codepoints, int count, Vector2 position, float fontSize, float spacing, Color tint);
        ...
        public static extern char8* LoadUTF8(const int * codepoints, int length);
        ...
        public static extern char8* TextJoin(const char ** textList, int count, char8* delimiter);
        
        [CallingConvention(.Cdecl), LinkName("TextSplit")]
        /// Split text into multiple strings
        public static extern const char ** TextSplit(char8* text, char delimiter, int * count);
        ...
        public static extern void UpdateMeshBuffer(Mesh mesh, int index, const void * data, int dataSize, int offset);
        ...
        public static extern void DrawMeshInstanced(Mesh mesh, Material material, const Matrix * transforms, int instances);
        ...
        public static extern ModelAnimation * LoadModelAnimations(char8* fileName, unsigned int * animCount);
        ...
        public static extern Wave LoadWaveFromMemory(char8* fileType, const unsigned char * fileData, int dataSize);
        ...
        public static extern void UpdateSound(Sound sound, const void * data, int sampleCount);
        ...
        public static extern Music LoadMusicStreamFromMemory(char8* fileType, const unsigned char * data, int dataSize);
        ...
        public static extern AudioStream LoadAudioStream(c_uint sampleRate, c_uint sampleSize, c_uint channels);
        ...
        public static extern void UpdateAudioStream(AudioStream stream, const void * data, int frameCount);
